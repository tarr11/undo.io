...
describe TeamProductRequestsController do
  ...
  # TeamProductRequestsController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all team_product_requests as @team_product_requests" do
      team_product_request = TeamProductRequest.create! valid_attributes
      get :index, {}, valid_session
      assigns(:team_product_requests).should eq([team_product_request])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new TeamProductRequest" do
        expect {
          post :create, {:team_product_request => valid_attributes}, valid_session
        }.to change(TeamProductRequest, :count).by(1)
      end

      it "assigns a newly created team_product_request as @team_product_request" do
        post :create, {:team_product_request => valid_attributes}, valid_session
        assigns(:team_product_request).should be_a(TeamProductRequest)
        assigns(:team_product_request).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved team_product_request as @team_product_request" do
        # Trigger the behavior that occurs when invalid params are submitted
        TeamProductRequest.any_instance.stub(:save).and_return(false)
        post :create, {:team_product_request => {}}, valid_session
        assigns(:team_product_request).should be_a_new(TeamProductRequest)
      end
